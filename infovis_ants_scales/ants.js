    ...
    const onClickLeg = function (clickedDataItem, left) {
        ...
        data = data
            .map(i => {
                    ...
                    i.larghezzaAddome = scaleEye.range(minMaxLeg)(i.larghezzaAddome);
                    i.horizontalPosition = scaleX.range(minMaxLeg)(i.horizontalPosition);
                    i.verticalPosition = scaleY.range(minMaxLeg)(i.verticalPosition);
                    i.lunghezzaAntenna = scaleLeg.range(minMaxLeg)(i.lunghezzaAntenna);
                    i.eyeDimension = scaleLeg.range(minMaxLeg)(i.eyeDimension);
                return i;
            });
    ...
    const onClickBody = function (clickedDataItem, left) {
        ...
        data = data
            .map(i => {
                    ...
                    i.EyeDimension = scaleEye.range(minMaxAddome)(i.EyeDimension);
                    i.horizontalPosition = scaleX.range(minMaxAddome)(i.horizontalPosition);
                    i.verticalPosition = scaleY.range(minMaxAddome)(i.verticalPosition);
                    i.legLength = scaleLeg.range(minMaxAddome)(i.legLength);
                    i.lunghezzaAntenna = scaleLeg.range(minMaxAddome)(i.lunghezzaAntenna);
     ...
     const onClickEye = function (clickedDataItem, left) {
        ...
        data = data
            .map(i => {
                    ...
                    i.larghezzaAddome = scaleEye.range(minMaxEye)(i.larghezzaAddome);
                    i.horizontalPosition = scaleX.range(minMaxEye)(i.horizontalPosition);
                    i.verticalPosition = scaleY.range(minMaxEye)(i.verticalPosition);
                    i.legLength = scaleLeg.range(minMaxEye)(i.legLength);
                    i.lunghezzaAntenna = scaleLeg.range(minMaxEye)(i.lunghezzaAntenna);
    ...
    const onClickAntenna = function (clickedDataItem, left) {
        ...
        data = data
            .map(i => {
                    ...
                    i.larghezzaAddome = scaleEye.range(minMaxAntenna)(i.larghezzaAddome);
                    i.horizontalPosition = scaleX.range(minMaxAntenna)(i.horizontalPosition);
                    i.verticalPosition = scaleY.range(minMaxAntenna)(i.verticalPosition);
                    i.legLength = scaleLeg.range(minMaxAntenna)(i.legLength);
                    i.eyeDimension = scaleLeg.range(minMaxAntenna)(i.eyeDimension);
